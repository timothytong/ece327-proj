...
# Attributes
#################
set_attribute -name HIERARCHY -value "preserve_interface_block" -instance stage1 -design gatelevel 
set_attribute -name HIERARCHY -value "preserve_interface_block" -instance stage2 -design gatelevel 
...
set_attribute -name HIERARCHY -value "preserve_interface_block" -instance stage1/u_max1 -design gatelevel 
set_attribute -name HIERARCHY -value "preserve_interface_block" /work/stage1_hardware/main_unfold_1260 -design gatelevel 
set_attribute -name HIERARCHY -value "preserve_interface_block" /work/custom_max_8/main_unfold_1856 -design gatelevel 


set_attribute -name HIERARCHY -value "preserve_interface_block" -instance stage2/u_max2 -design gatelevel 
